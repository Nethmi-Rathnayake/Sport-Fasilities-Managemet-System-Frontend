      ...
      <div className="max-w-xl mx-auto w-full">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <button
            ...
            className="w-full bg-blue-700 hover:bg-blue-800 disabled:bg-blue-300 text-white font-semibold py-3 rounded-lg text-sm mt-5 transition"
          >
          ...
          <button
            onClick={() => navigate(-1)}
            disabled={paying}
            className="w-full text-sm text-gray-500 hover:text-blue-600 transition mt-3 disabled:opacity-50"
          >
            Back
          </button>
        </div>
